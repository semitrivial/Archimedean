...
The reader might object that the above theories-with-proofs example is overly contrived.
...
bizarre C++ templates that would never organically arise in an actual software
...
non-Archimedean tasks, which, however contrived they are, could certainly be
