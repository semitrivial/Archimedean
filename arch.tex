...
\]
David Tall described \cite{tall1980looking} how to turn these formal series into a
real-number-extending number
system (which he calls the ``superreals'', but this vocabulary does not seem
to have caught on). The advantage of this number system is that it is
