...
\label{speculativeexamples}
    ...
    \begin{itemize}
        ...
        \item
        (Ethical utility)
        An early utilitarian, Jeremy Bentham, suggested a kind of hedonistic
        ...
        the lines, Mill seems to be suggesting there exist pleasures $P_0$ and $P_\infty$
        such that $P_\infty$ is superior to $P_0$, as well as to ``experiencing $P_0$
        twice'' and to ``experiencing $P_0$ thrice'' and so on. If so, this would make
        utilitarian pleasures non-Archimedean.
        \item
        (AGI)
